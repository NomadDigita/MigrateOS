...
export function CodingClubStage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-[590px] max-w-[690px] flex-col justify-end p-7 sm:p-12">
        <div className="max-w-xl rounded-[1.75rem] border border-white/20 bg-[#0b1026]/52 p-6 shadow-[0_28px_70px_rgba(0,0,0,0.34)] backdrop-blur-2xl sm:p-8">
